...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('5uah3Ubz7G', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5AiENydhIU', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uW4Y1jBpTJ', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FT-QllRi6v', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GZOd6Ddh3P', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/ex00Bundle/Resources/views'), 'ex00');
        $instance->addPath(($this->targetDirs[3].'/src/ex00Bundle/Resources/views'), '!ex00');
        $instance->addPath(($this->targetDirs[3].'/src/ex01Bundle/Resources/views'), 'ex01');
        $instance->addPath(($this->targetDirs[3].'/src/ex01Bundle/Resources/views'), '!ex01');
        $instance->addPath(($this->targetDirs[3].'/src/ex02Bundle/Resources/views'), 'ex02');
        $instance->addPath(($this->targetDirs[3].'/src/ex02Bundle/Resources/views'), '!ex02');
        $instance->addPath(($this->targetDirs[3].'/src/ex03Bundle/Resources/views'), 'ex03');
        $instance->addPath(($this->targetDirs[3].'/src/ex03Bundle/Resources/views'), '!ex03');
        $instance->addPath(($this->targetDirs[3].'/src/ex04Bundle/Resources/views'), 'ex04');
        $instance->addPath(($this->targetDirs[3].'/src/ex04Bundle/Resources/views'), '!ex04');
        $instance->addPath(($this->targetDirs[3].'/src/ex05Bundle/Resources/views'), 'ex05');
        $instance->addPath(($this->targetDirs[3].'/src/ex05Bundle/Resources/views'), '!ex05');
        $instance->addPath(($this->targetDirs[3].'/src/ex06Bundle/Resources/views'), 'ex06');
        $instance->addPath(($this->targetDirs[3].'/src/ex06Bundle/Resources/views'), '!ex06');
        $instance->addPath(($this->targetDirs[3].'/src/ex07Bundle/Resources/views'), 'ex07');
        $instance->addPath(($this->targetDirs[3].'/src/ex07Bundle/Resources/views'), '!ex07');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'ex00Bundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/ex00Bundle'),
                    'namespace' => 'ex00Bundle',
                ),
                'ex01Bundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/ex01Bundle'),
                    'namespace' => 'ex01Bundle',
                ),
                'ex02Bundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/ex02Bundle'),
                    'namespace' => 'ex02Bundle',
                ),
                'ex03Bundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/ex03Bundle'),
                    'namespace' => 'ex03Bundle',
                ),
                'ex04Bundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/ex04Bundle'),
                    'namespace' => 'ex04Bundle',
                ),
                'ex05Bundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/ex05Bundle'),
                    'namespace' => 'ex05Bundle',
                ),
                'ex06Bundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/ex06Bundle'),
                    'namespace' => 'ex06Bundle',
                ),
                'ex07Bundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/ex07Bundle'),
                    'namespace' => 'ex07Bundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ex00Bundle' => 'ex00Bundle\\ex00Bundle',
                'ex01Bundle' => 'ex01Bundle\\ex01Bundle',
                'ex02Bundle' => 'ex02Bundle\\ex02Bundle',
                'ex03Bundle' => 'ex03Bundle\\ex03Bundle',
                'ex04Bundle' => 'ex04Bundle\\ex04Bundle',
                'ex05Bundle' => 'ex05Bundle\\ex05Bundle',
                'ex06Bundle' => 'ex06Bundle\\ex06Bundle',
                'ex07Bundle' => 'ex07Bundle\\ex07Bundle',
            ...
            'database_port' => 3306,
            'database_name' => 'sql2241525',
            'database_user' => 'sql2241525',
            'database_password' => 'bJ7*sP3!',
