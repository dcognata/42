...
return $this->services['services_resetter'] = new \Symfony\Component\HttpKernel\DependencyInjection\ServicesResetter(new RewindableGenerator(function () {
    ...
    if (isset($this->services['white_october_breadcrumbs'])) {
        yield 'WhiteOctober\\BreadcrumbsBundle\\Model\\Breadcrumbs' => ${($_ = isset($this->services['white_october_breadcrumbs']) ? $this->services['white_october_breadcrumbs'] : null) && false ?: '_'};
    }
}, function () {
    return 0 + (int) (isset($this->services['profiler'])) + (int) (isset($this->services['validator'])) + (int) (isset($this->services['debug.stopwatch'])) + (int) (isset($this->services['security.token_storage'])) + (int) (isset($this->services['form.type.entity'])) + (int) (isset($this->services['white_october_breadcrumbs']));
}), array('profiler' => 'reset', 'debug.validator' => 'reset', 'debug.stopwatch' => 'reset', 'security.token_storage' => 'setToken', 'form.type.entity' => 'reset', 'WhiteOctober\\BreadcrumbsBundle\\Model\\Breadcrumbs' => 'clear'));
