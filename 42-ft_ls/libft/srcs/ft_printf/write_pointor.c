...
/*   Updated: 2018/09/20 11:35:19 by dcognata         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static void		wr_prec(t_pf_env *e, int w, int lng)
{
	int			i;
	int			j;
...
static void		wr_base(t_pf_env *e, int lng, int b)
{
	int			w;
	int			i;
...
static void		w_justify(t_pf_env *e, int lng, char *str)
{
...
void			printf_write_pointor(t_pf_env *e, va_list ap)
{
	...
	if (printf_except_p(e, (unsigned long long)d))
		return ;
