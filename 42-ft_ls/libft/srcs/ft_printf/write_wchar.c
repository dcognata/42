...
/*   Updated: 2018/09/20 11:35:14 by dcognata         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	wr_justify(t_pf_env *e, int nb)
{
	char	c;
...
static void	wl_justify(t_pf_env *e, int nb)
{
	char	c;
	int		tmp;
...
static void	checkjust(t_pf_env *e, int i, wchar_t c)
{
